...
/*Caso 1: los sensores estan a una distancia de la pared izquierda entre 5 y 9 cm, la diferencia entre sensores es menor a 2 cm*/
  ...
  if ( (Diferencia < 20) && (DistanceB_mm > 50) && (DistanceB_mm < 90) && (DistanceC_mm > 50) && (DistanceB_mm < 90) ) {
...
/*Caso 2: algún sensor esta más lejos que 9 cm de la pared izquierda*/
  ...
  else if ( (DistanceB_mm > 90) || (DistanceC_mm > 90) ) {
...
/*Caso 3: algún sensor esta a menos de 5 cm de la pared izquierda*/
  ...
  else if ( (DistanceB_mm < 50) || (DistanceC_mm < 50) ) {
...
/*Caso 4: se llega a una esquina, por ende debe girar a la derecha*/
 
  if (DistanceA_mm < 80 && DistanceB_mm < 80 && DistanceC_mm < 80) {
    while(DistanceA_mm<80){ 
      // gira a la derecha 
